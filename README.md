<!-- TOC -->
  ...
  * [Facet Loader](#facet-loader)
    ...
    * [Testing requests with FacetLoader.http](#testing-requests-with-facetloaderhttp)
  * [Running dev application locally on command line](#running-dev-application-locally-on-command-line)
<!-- TOC -->
